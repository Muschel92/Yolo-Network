...
function calculate_correct_output_cec(output, correction)
  confidence = 0
  classification = 0
  -- set class output to zero for non-object positions
  output[{{},{}, {opt.boxes_per_grid *5 + 1, output:size(3)}}][torch.eq(correction[4], 0)] = 0
  output[{{},{}, {opt.boxes_per_grid *5 + 1, output:size(3)}}][torch.eq(correction[4], 3)] = 1
  
  correction[4][correction[4]:eq(3)] = 0
